...
## 🎯 Vision
Build a comprehensive, modern UI component library for Angular that is:
- Easy to use
- Highly customizable
- Accessible
- Well-documented
...
- [ ] Add Angular schematics for easy setup
...
Have an idea? [Open a feature request](https://github.com/sunilsolankiji/perfect-ui/issues/new?template=feature_request.md)!
